...
COMMANDS = ["arm",
            ...
            "startfollow",#start follow mode
            "followtarget", #followed with args:set follow target
            "stopfollow", #stop follow mode
            "hold"] #followed with args: hold time
...
async def originAsync(drone, info):    
    ...
    await asyncio.sleep(INFO_UPDATE_PERIOD * 50)
